    ...
    <div v-else>
        ...
        <section class="create-post">
            ...
            <div class="blog-editor">
                ...
                toolbar_sticky: true
                }" api-key="xmq1ywq6h6q4hr103598lgqqscssr5ks4b4azwwpkpq56blq" />
            </div>
            <div class="blog-tags">
        ...
        methods: {
            ...
            async confirmModal() {
                ...
                if ((this.blogCoverPhoto) && (this.blogTitle) && (this.blogHTML) && (this.blogTagsText)) {
                    ...
                    const response = await fetch('https://api.imgbb.com/1/upload?key=f753dfd19fbe77d5806b226863ec9dfe', {
                        method: 'POST',
                        body: formData
                    });
                    ...
                    if (!response.ok) {
                        this.error2 = true;
                        this.errorMessage2 = result.error.message;
                        return;
                    }
                    ...
                    for (let i = 0; i < this.blogsWithSameFileName.length; i++) {
                        const docRef = doc(db, 'bXlibG9nc2xpc3Q', this.blogsWithSameFileName[i].blogID);
                        await updateDoc(docRef, {
                            blogCoverPhoto: this.blogCoverPhoto,
                            blogCoverFileURL: photoURL
                        })
                    }
                    const docRef = doc(db, 'bXl1c2Vyc2xpc3Q', auth.currentUser.uid);
